...
First, [fork](https://github.com/SkyBotsDeveloper/inlinexgamesbot/fork) this repository, checkout it locally and then install project dependencies with Composer - `composer install`.
...
Now when all seems to be good push you changes to a new branch in your fork and then [create a pull request](https://github.com/SkyBotsDeveloper/inlinexgamesbot/compare) explaining all the changes.
